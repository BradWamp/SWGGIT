...
public class DogGenetics {
   public static void main( String args[] ) {
      ...
      System.out.println(dogType2 + "% St. Bernard");
      System.out.println(dogType3 + "% St. Bernard");
      System.out.println(dogType4 + "% St. Bernard");
      System.out.println(dogType5 + "% St. Bernard");
                 System.out.println();
