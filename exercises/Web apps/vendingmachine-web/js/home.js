...
function returnChange(){
  ...
  var dimes =0;
  var nickels =0;
// calculate how many of each coins need to be returned
  while(change > 0){
      while(change >= 25)
      {
        change = change - 25;
  ...
  //reset all inputs and messages also assign the value of the change div to the coins that need to be returned.
  $('#change')
...
// so that duplicates don't appear.
  clearItems();
...
//this creates all of the boxes for the items that can be vended.
