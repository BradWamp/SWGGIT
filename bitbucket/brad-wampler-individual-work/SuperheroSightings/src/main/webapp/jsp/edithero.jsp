                ...
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input value="${updateHero.heroName}" type="text" class="form-control" name="heroName" placeholder="Hero Name"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input value="${updateHero.heroDesc}" type="text" class="form-control" name="heroDesc" placeholder="Enter a short description"/>
                            </div>
                        </div>
                        <div class="form-group">
