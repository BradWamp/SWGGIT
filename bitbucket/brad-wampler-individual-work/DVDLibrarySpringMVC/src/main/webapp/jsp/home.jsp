...
<html>
    ...
    <body>
        <h2>Dvd Library: List All In Library</h2
        <br>
        <div class="container">
            <div class="navbar">
            ...
            <table id="DvdTable" class="table table-hover">
                ...
                <c:forEach var="currentDvd" items="${dvdList}">
                    <tr>
                        <td>
                            <a href="dvdDetail?dvdId=${currentDvd.dvdId}">
                        ...
                        <td>
                            <a href="editDvdDetails?dvdId=${currentDvd.dvdId}">
                                <button>Edit</button>
                            </a>
                        </td>
                        <td>
                            <a href="deleteDvd?dvdId=${currentDvd.dvdId}" onclick="return confirm('Are you sure? Dvd will be deleted.')">
