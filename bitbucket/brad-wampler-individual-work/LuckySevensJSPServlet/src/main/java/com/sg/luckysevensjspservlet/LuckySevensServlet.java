...
public class LuckySevensServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int userMoneyInt = Integer.parseInt(userMoney);
        //request.setAttribute("userMoney", userMoney);
        
        Random diceRandom = new Random();
        int dice1, dice2, sumDice, maxMoney, maxMoneyRound, roundCounter;
        
        maxMoney = userMoneyInt;
        roundCounter = 0;
        maxMoneyRound = roundCounter;
               
        while (userMoneyInt > .99) {
                      
            dice1 = diceRandom.nextInt(7);
            dice2 = diceRandom.nextInt(7);
            sumDice = dice1 + dice2;
            roundCounter++;
        ...
        request.setAttribute("maxMoneyRound", maxMoneyRound);
        request.setAttribute("roundCounter", roundCounter);
